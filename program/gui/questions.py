...
### a label at row 2 is dyanmically generated in next_question() so do not add anything coz it  will be hidden by that label
        ...
        first_label_question = tk.Label(
            self.first_question_frame, text="Click on the next button when you are ready for test. Reading time for all questions will be " + str(self.question_read_time) + " secs", font=LARGEFONT)
...
# initially show the first question
        ...
        self.label_clock_timer = ttk.Label(self, text="Time remaining will be displaced here", font=LARGEFONT)
        ...
        # by using grid
        self.buttonNext.grid(row=4, column=0, padx=10, pady=10)
    ...
    def next_question(self):
        ...
        def start_recording():
            ...
            label_question = tk.Label(current_frame, text="Question Reading recording starts", font=LARGEFONT)
            ...
            label_question.configure(text="Answering recording starts")
    ...
    def show_last_frame(self):
        ...
        self.buttonNext.configure(
            text="Go to Mcq section", command=lambda: self.controller.show_frame(mcq_main.Quiz))
        # 
        # self.buttonNext.configure(
